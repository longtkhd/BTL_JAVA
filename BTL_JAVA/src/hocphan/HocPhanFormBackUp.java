 ...
 * @author tunga
 */
public class HocPhanFormBackUp extends javax.swing.JDialog {
    HocPhanDB db = new HocPhanDB();
    ArrayList<HocPhan> ds;
    /**
     * Creates new form HocPhanForm
     */
    public HocPhanFormBackUp(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HocPhanFormBackUp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {                
                HocPhanFormBackUp hocPhanForm = new HocPhanFormBackUp(new javax.swing.JFrame(), true);
                hocPhanForm.addWindowListener(new java.awt.event.WindowAdapter() {
                    @Override
                    public void windowClosing(java.awt.event.WindowEvent e) {
                        System.exit(0);
                    }
                });
                hocPhanForm.setVisible(true);
            }
        });
    }
