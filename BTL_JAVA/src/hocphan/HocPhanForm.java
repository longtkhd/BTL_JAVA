 ...
 * @author tunga
 */
public class HocPhanForm extends javax.swing.JDialog {
     ...
     */
    public HocPhanForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HocPhanForm dialog = new HocPhanForm(new javax.swing.JFrame(), true);
